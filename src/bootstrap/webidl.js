...
function assertBranded(self, prototype) {
  if (!ObjectPrototypeIsPrototypeOf(prototype, self) || self[brand] !== brand) {
  ...
  const properties = {
    ...
    forEach: {
      value: function forEach(idlCallback, thisArg = undefined) {
        ...
        idlCallback = FunctionPrototypeBind(idlCallback, thisArg ?? globalThis);
