...
export interface IntConverterOpts {
  /**
 ...
 */
export function createAsyncIterableConverter<V, T>(
...
export function createRecordConverter<K extends string | number | symbol, V>(
 ...
 */
export function configureInterface(prototype: any);
